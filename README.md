...
- Todo XML deve ter na segunda linha  o seguinte cabeçalho <PED Tipo="XX" CodigoEmpresa="YY"> onde:
	XX= Tipos do XML, que podem ser:
		MOVIMENTACAOFINANCEIRA	para enviar informações sobre a Movimentação Financeira das Contas Contábeis de Pesquisa e Desenvolvimento.
		PROGRAMA	para enviar o Plano Estratégico de Investimentos em P&D.
